...
Rust-Crypto targets the current, stable build of the Rust language (currently 1.5).
...
audited for correctness, so any use where security is important is not yet recommended.
